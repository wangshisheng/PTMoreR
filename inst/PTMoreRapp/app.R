    ...
    fluidRow(div(
      HTML(
        "<div style='text-align:center;margin-top:20px;margin-right:0px'>
          <a href='#' target=''><img src='PTMoreRti.png' width='200px'>
          </a>
          </div>"
      )
    )),
      ...
      tabPanel(
        ...
        sidebarLayout(
          sidebarPanel(
            width = 3,
            h3(
              "Step3: Blast to the other species",#Human proteins
              tags$span(
                id = 'span3',
                `data-toggle` = "tooltip3",
                title = '
                This step will map the PTM site and protein sequences and identifiers between two species (One is that you chose in Step 1 and the other is that you want to blast to, which can be chosen below.).
                ',
                tags$span(class = "glyphicon glyphicon-question-sign")
              )
            ),
            ...
            bsTooltip("preblastif_div",'By default, the pre-blast results only contain Human data, which means that if true, you will map your data with Human protein sequences. Otherwise, if you want to blast other species, you can unselect this parameter and select/upload the fasta file below. Please Note: This step is a little time-consuming! If true, this tool will retrieve the pre-blast results and it will be faster to finish this step. Otherwise, this tool will blast the uploaded sequences against those protein sequences of the other species, which will take more time, perhaps several hours.',
                      placement = "right",options = list(container = "body")),
            #bsTooltip("preblastif_div",'By default, the pre-blast results only contain Human data, which means that if true and do not upload anything below (1.1. and 1.2. parameters), you will map your data with Human protein sequences. However, if you want to blast other species, you can unselect this parameter and upload the results below (1.1. and 1.2. parameters). The results can be obtained and downloaded after blasting in the right panel. Please Note: This step is a little time-consuming! If true, this tool will retrieve the pre-blast results and it will be faster to finish this step. Otherwise, this tool will blast the uploaded sequences against those protein sequences of the other species, which will take more time, perhaps several hours.',
            #          placement = "right",options = list(container = "body")),
            #conditionalPanel(
            #  condition="input.preblastif==true",
            #  textInput("preblastbetweentwo",h5("1.1. Type in the filename of the blast results between two species:"),value = ""),
            #  textInput("preblastproseq",h5("1.2. Type in the filename of the blast protein sequence results:"),value = ""),
            #),
            #conditionalPanel(
            #  condition="input.preblastif==true",
            #  fileInput('preblastbetweentwo', h5('1.1. Please upload the blast results between two species:'),accept=c('.RData')),
            #  fileInput('preblastproseq', h5('1.2. Please upload the blast protein sequence results:'),accept=c('.RData')),
            #  textInput("wuzhong2id","Taxonomic identifier of the other species:",value = "",placeholder = "9606")
            #),
            conditionalPanel(
            ...
            #          placement = "bottom",options = list(container = "body"))
            div(id="centeraamatach_div",selectInput("centeraamatach",h5("4. Central amino acid matching degree:"),choices = c("All"=1,"Fuzzy matching"=2,"Exact matching"=3))),
            bsTooltip("centeraamatach_div",'The matching degree of central amino acids (CAAs) when the uploaded peptides are blasted to Human protein sequences. 1. Exact matching: The CAAs are same, for example, the CAA is "S" in the uploaded peptides and the CAA is also "S" in the blasted sequence. 2. Fuzzy matching: For example, the CAA is "S" in the uploaded peptides and the CAA could be "S", "T", or "Y" in the blasted sequence. All: Reporting all results.',
                      placement = "right",options = list(container = "body")),
            div(id="seqmatachsimilar_div",numericInput("seqmatachsimilar",h5("5. Sequence windows similarity:"),value = 8)),
          ...
          mainPanel(
            ...
            radioButtons("blastresultindex",label=h4("The blast results:"),choices = list("1. Best blast results between two species" = 1,"2. Blast protein sequences"=2,"3. Final blast results"=3),
                         selected = 1,inline = TRUE),
            tags$hr(style="border-color: grey;"),
            conditionalPanel(
              condition = "input.blastresultindex==1",
              downloadButton("blastres1dl","Download"),
              uiOutput("blastres1save"),
              dataTableOutput("blastres1")
            ),
            conditionalPanel(
              condition = "input.blastresultindex==2",
              downloadButton("blastres2dl","Download"),
              uiOutput("blastres2save"),
              verbatimTextOutput("blastres2")
            ),
            conditionalPanel(
              condition = "input.blastresultindex==3",
              fluidRow(
                column(
                  2,
        ...
        sidebarLayout(
          sidebarPanel(
            ...
            bsTooltip("equalheightif_div",'Whether all residues in the figure have equal height. Default is false.',
                      placement = "bottom",options = list(container = "body")),
            numericInput("motifplot_height",h5("6. Figure height:"),value = 800),
            tags$hr(style="border-color: grey;"),
      ...
      tabPanel(
        ...
        sidebarLayout(
          sidebarPanel(
            width = 3,
            h3(
              "Step 5: Annotation and enrichment analysis based on Kinase-Substrate database",
              tags$span(
                id = 'span5',
          ...
          mainPanel(
            ...
            conditionalPanel(
              ...
              fluidRow(
                ...
                column(
                  3,
                  numericInput("interactfigheight",h5("3.6 Figure Height:"),800)
                )
              ),
      ...
      tabPanel(
        ...
        navlistPanel(
          ...
          tabPanel(
            ...
            div(style="text-align:left;margin-top:15px;font-size:160%;",HTML("<b>Please note: Here is a quite overview about how to use PTMoreR. More detailed user manual can be found here: .</b>")),
            div(style="text-align:left;margin-top:20px;font-size:150%;",HTML("<b>2.1 Input data preparation</b>")),
            div(
              style="text-align:justify;width:fit-content;width:-webkit-fit-content;width:-moz-fit-content;font-size:120%;margin-top:10px;margin-right:20px;",
              HTML("PTMoreR supports five basic file formats (.csv, .txt, .xlsx, .xls and .fasta). Before analysis, users should prepare their peptide sequences with modification.
            ...
            div(
              style="text-align:justify;width:fit-content;width:-webkit-fit-content;width:-moz-fit-content;font-size:120%;margin-top:10px;margin-right:20px;",
              "Then click '2. Processed expression data' panel. PTMoreR will process median normalization, missing value imputation with KNN method, log data with base 2 by default."
            ),
            div(style="text-align:center;margin-top:8px;",
                a(href='#',
            ...
            div(
              ...
              HTML("If you have any questions, comments or suggestions about PTMoreR, please feel free to contact: <u>shishengwang@wchscu.cn</u>. We really appreciate that you use PTMoreR, and your suggestions should be valuable to its improvement in the future.")
            ),
            icon = icon("file-alt")
          ),
          widths=c(3,9)
      ...
      div(
        ...
        column(
          ...
          div(style="text-align:left;margin-top:20px;font-size:140%;color:darkred",
              HTML("~~ <em>Dear Users, Welcome to PTMoreR</em> ~~")),
          ...
          div(style="text-align:center;margin-top: 20px;font-size:100%",
              HTML(" &copy; 2022 <a href='https://www.yslproteomics.org/' target='_blank'>Yansheng Liu's Group</a> and <a href='http://english.cd120.com/' target='_blank'>Hao Yang's Group</a>. All Rights Reserved.")),
