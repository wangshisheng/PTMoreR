            ...
            column(
              ...
              column(
                ...
                box(width = 12, inputId = "input_card5", 
                    ...
                    bsTooltip("ksdatabasetype",'Which kind of Kinase-Substrate (KS) database users want to choose. From PhosphoPlus means the KS database was downloaded from the PhosphoPlus database, and From the Kinase library (top 1) means the KS database was produced from the Kinase Library (Lew Cantley et al. 2024) with the topmost percentile. The Kinase library (above 0.99) means the KS database was produced from the Kinase Library with percentile > 0.99.',
                              placement = "right",options = list(container = "body")),
                    #uiOutput("kinasemotifui"),
                    tags$hr(style="border-color: grey;"),
