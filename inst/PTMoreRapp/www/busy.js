...
$(function () {
			var x = 10;
			var y = 20;
			$("#span5").mouseover(function (e) {
				this.myTitle = this.title;
				this.title = "";
				var tooltip = "<div id='tooltip5'>" + this.myTitle + "<\/div>"; //创建 div 元素 文字提示
				$("body").append(tooltip);	//把它追加到文档中
				$("#tooltip5").css({
					"top": (e.pageY + y) + "px",
					"left": (e.pageX + x) + "px"
...
$(function () {
			var x = 10;
			var y = 20;
			$("#span6").mouseover(function (e) {
				this.myTitle = this.title;
				this.title = "";
				var tooltip = "<div id='tooltip6'>" + this.myTitle + "<\/div>"; //创建 div 元素 文字提示
				$("body").append(tooltip);	//把它追加到文档中
				$("#tooltip6").css({
					"top": (e.pageY + y) + "px",
					"left": (e.pageX + x) + "px"
